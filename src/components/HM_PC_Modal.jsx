...
function HM_PC_Modal({ toggleContainerHmPc, hm_pc_id, hm_pc_data }) {
    console.log(hm_pc_data);
    ...
    const sendRemarks = async (responseData, status) => {
        ...
        try {
            const response = await fetch(
                `${process.env.REACT_APP_BASE_URL2}/hmpc/sethmpccrmver`,
                {
                    method: "PUT",
                    headers: {
    ...
    return (hm_pc_data &&
        <>
            <div className='view_container'>
                <div>
                    <h4 className="heading_contant">HM-PC Details</h4>
                ...
                <div className='sub_div'>
                    <div className='lead_details_container'>
                        ...
                        <div className="fields">
                            ...
                            <input type="number" name="hm_aadhaar_card_no" id="hm_aadhaar_card_no" value={formData.hm_aadhaar_card_no || ""} onChange={handleInputChange} readOnly />
                        </div>
                        ...
                        <div className="fields">
                            <label>HM DOB</label>
                            <input type="number" name="dob_of_hm" id="dob_of_hm" value={formData.dob_of_hm || ""} onChange={handleInputChange} readOnly />
                        </div>
                        <div className="fields">
                            <label>PC Name</label>
